/**
 * @authors Nour Hatem / Youssef Karam
 * @date 2022/12/17
 * @version 1.0
 * @brief This is the main file of the project
 * @details This is the standard vector implementation
 *
 */
#include <iostream>
using namespace std;
 ...
 * @details this class is used to throw an exception when the vector is empty
 */
